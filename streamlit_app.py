...
# 03/25/2025 Fixing below two lines
...
# 03/25/2025 Attempted fix below 
temples = pq.read_table("data/temple_details_spatial.parquet")
tract_nearest = pq.read_table("data/tract_distance_to_nearest_temple.parquet")
